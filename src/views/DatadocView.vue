      ...
      <div class="workspace">
        <div class="ws-search">
          <div class="searchbar">
            ...
            <input
              id="search"
              placeholder="Filter: &quot;Oslofjord&quot; AND &quot;SST&quot; AND &quot;NetCDF&quot;..."
            />
          </div>
          ...
          <div style="display:flex; gap:8px; align-items:center; flex-wrap:wrap;">
            ...
            >
              Selected: <span
                id="chip-selected-text"
                style="color:var(--text); font-weight:800;"
              ></span>
              <button
          ...
          <div class="panel-header">
            ...
            <div class="center-tools">
              ...
              <button
                id="btn-view-graph"
                class="btn"
                onclick="ui.setCenterView('graph')"
              >
        ...
        >
          <div class="panel-header">
            ...
            <div style="display:flex; gap: 8px; align-items:center;">
              <span
                id="wizard-section-pill"
                class="pill"
              >—</span>
              <button
                class="btn"
                onclick="ui.navigate('explorer')"
              >
                <i class="fa-solid fa-compass"></i> Explorer
              </button>
            </div>
          ...
          >
            <div class="kv">
              ...
              <span
                class="v"
                style="font-family: var(--font-sans); color: var(--text-muted);"
              >
            ...
            <div class="callout">
              <div class="hd">
                <i class="fa-solid fa-circle-check"></i> Output per published version
              </div>
              <ul>
